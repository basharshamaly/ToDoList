          ...
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="{{ route('droplists.index') }}" class="nav-link">
                        <i class="fas fa-eye"></i>
                      <p>index</p>
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a href="{{ route('droplists.create') }}" class="nav-link">
                        <i class="fas fa-plus-circle"></i>
                      <p>create</p>
                    </a>
                  </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">To Do ListPage</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">To Do ListPage</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
